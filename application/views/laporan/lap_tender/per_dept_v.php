    ...
    <div class="col-lg-12">
      ...
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          ...
          <button class="btn btn-info  dim btn-medium-dim btn-outline" type="button" style="height:60px;width:50%">
            <h2>
...
<script type="text/javascript">
  ...
  $(function () {
    ...
    $table_pekerjaan_kontrak.bootstrapTable({
      ...
      url: "<?php echo site_url('laporan/lap_tender/data_per_dept').'/'.$id ?>",
