    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          ...
          <?php 
          $curval = (isset($v['srv_group_code'])) ? $v['srv_group_code'] : set_value("group_inp[$i]");
          ...
          <?php 
          $curval = (isset($v['srv_catalog_code'])) ? $v['srv_catalog_code'] : set_value("code_inp[$i]");
         ...
         <?php 
          $curval = (isset($v['srv_unspsc_group_code'])) ? $v['srv_unspsc_group_code'] : set_value("code_inp[$i]");
          // $label = lang('UNSPSC code', "code_inp[$i]", array('class' => 'col-sm-2 control-label'));
          ?>
          <div class="form-group">
            <label class="col-sm-2 control-label">Kode UNSPSC (level 2)</label>
            <div class="col-sm-10">
             <p class="form-control-static"><?php echo $curval ?></p>
           </div>
         </div>
...
<?php echo buttonback('commodity/katalog/katalog_jasa_sumberdaya',lang('back'),lang('save')) ?>
</div>
</div>
