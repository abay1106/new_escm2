    ...
    <div class="ibox float-e-margins">
      ...
      <div class="table-responsive">
        <table class="table table-bordered" id="item_table">
          <thead>
            <tr>
              <th rowspan="2" style="width: 10px">KODE SUMBERDAYA</th>
              <th rowspan="2" ><center>NAMA SUMBERDAYA</center></th>
              <th rowspan="2" ><center>SATUAN {UOM}</center></th>
              <th colspan="3" ><center>RAB</center></th>
              <?php 
              foreach ($header as $k => $v) { ?>
                <th><center><?php echo $v['periode_pengadaan']."" ?></center></th>
              <?php }	?>								
            </tr>
          ...
          <tbody>
            <?php $i = 1; foreach ($item as $ky => $val) { ?>
              <tr>
                <td><?php echo $val['smbd_code']; ?></td>
                <td><?php echo $val['smbd_name']; ?></td>
                <td><?php echo $val['unit']; ?></td>
                <td><?php echo $val['ppv_remain']; ?></td>
                <td><?php echo $val['price']; ?></td>
                <td><?php echo $val['jumlah']; ?></td>

                <?php 
                foreach ($period[$ky] as $keys => $values) { ?>
                  <td>
                    <center><?php echo $values['smbd_quantity'] ?></center>
                  </td>
                <?php }	?>
              </tr>
            <?php $i++; } ?>
