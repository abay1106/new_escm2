...
<script type="text/javascript">
  ...
  $(function () {
    ...
    $table.bootstrapTable({
      ...
      url: "<?php echo site_url('administration/template_vpi/penilaian_penyedia_jasa/k3l/data_k3l') ?>",
        ...
        editable: {
          ...
          validate: function(v) {
              if(!v){ return 'Required field!'}
                  ...
                  $.ajax({
                  url: "<?php echo site_url('administration/template_vpi/penilaian_penyedia_jasa/k3l/update?key=urutan&data=') ?>"+v,
                  type:"get"
                });
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#ak_form').submit(function(e) {
      ...
      $('#ak_form').ajaxSubmit({
        url: '<?php echo site_url('administration/template_vpi/penilaian_penyedia_jasa/k3l/submit_add') ?>', 
        type: 'post',
   ...
   $remove.click(function(e) {
    if (confirm('Apakah anda yakin?') == true) {
      e.preventDefault(); // avoid to execute the actual submit of the form.
           $.ajax({
                 type: "POST",
                 url: "<?php echo site_url('administration/template_vpi/penilaian_penyedia_jasa/k3l/nonaktif');?>",
                 success: function(data)
                 {
      ...
      $activate.click(function(e) {
        if (confirm('Apakah anda yakin?') == true) {
          e.preventDefault(); // avoid to execute the actual submit of the form.
           $.ajax({
                 type: "POST",
                 url: "<?php echo site_url('administration/template_vpi/penilaian_penyedia_jasa/k3l/aktifkan');?>",
                 success: function(data)
                 {
                     alert(data); // show response from the php script.
                     $table.bootstrapTable('refresh');
