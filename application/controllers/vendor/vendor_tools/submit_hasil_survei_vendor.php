...
$next_state = ($input['status_inp'][0] == "662") ? 1 : 0;
...
$vendor_com = [
	...
	'vc_attachment' => $input['comment_attachment_inp'][0],
...
$data['survey_result'] = $input['doc_attachment2_inp'];
$data['survey_date'] = $input['survey_date_inp'];
