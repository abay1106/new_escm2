<div class="row">
	<div class="col-7">
		<div class="content-header"><strong><?php echo $this->lang->line('Informasi Umum'); ?></strong></div>			
	</div>
	<div class="col-5">
				...
				<div class="card-body">
					<table class="table">
						...
						<tr>
							...
							<td><?php if(!empty($header["ptp_eauction"]) && $header["ptp_eauction"] == '1') { echo "Ya"; } else { echo "Tidak"; } ?></td>
						</tr>
						<!-- end -->
