...
function stat_format3(value,row,index){
  var lbl="success";
  if(row['ctr_skbdn_no']){
    lbl="primary";
    value="SKBDN Selesai";
  }
  return ['<span class="label label-'+lbl+'">'+value+'</span>'].join();
}
...
$(function () {
  ...
  $table_pekerjaan_<?php echo $mod ?>.bootstrapTable({
    ...
    url: "<?php echo site_url('data_matgis/monitoring_task_matgis/skbdn') ?>",
