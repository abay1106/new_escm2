...
<form method="post" action="<?php echo site_url($controller_name."/submit_add_mat_catalog_smbd");?>"  class="form-horizontal">
...
<!--         <div class="form-group">
            ...
            <div class="col-sm-10" id="tipe_smbd_div_<?php echo $i ?>">
              ...
              <input type="hidden" name="is_matgis_inp[<?php echo $i ?>]" value=""  >
