      ...
      <div class="col-lg-12">
        <div class="ibox float-e-margins">
          ...
          foreach ($pertanyaan as $key => $value){ 
            ...
            ?> 
            <tr>
              <td><input type="radio" name="select_category" required class="radio_btn form-check-input select_category_<?php echo $no-1 ?>" data-no="<?php echo $no-1 ?>" <?php echo $selected ?>></td>
              <td><?php echo $no ?></td>
              <td>
              ...
              <td><input type="text" <?php echo $disabled ?> required class="form-control money answer_inp answer_inp_<?php echo $no-1 ?>" name="answer_inp" value="<?php echo $curval ?>"></td>
            </tr>
