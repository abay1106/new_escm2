    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-header border-bottom pb-2">
          ...
          <a class="btn btn-info float-right" href="<?php echo site_url('administration/master_data/delegasi_tugas/add_delegasi_tugas') ?>" role="button">Tambah</a>
        </div>
...
<script type="text/javascript">
  ...
  function operateFormattera(value, row, index) {
    ...
    return [
      '<a class="btn btn-sm btn-info ft ft-edit btn-xs action" href="' + link + '/ubah/' + value + '">',
      'Ubah',
      '</a>  ',
