          ...
          <div class="card-body">
            <div class="table-responsive">
              <table id="rks" class="table table-bordered table-striped">
                ...
                <a href="#" class="btn btn-info mr-3 btn-lg" data-toggle="modal" data-target="#rksHeader"><i class="ft ft-file-plus"></i> Header</a>
  							<?php if ($header > 0) { ?>
  								<a href="#" class="btn btn-info mr-3 btn-lg" data-toggle="modal" data-target="#rksSub"><i class="ft ft-file-plus"></i> Sub Header</a>
  								<a href="#" class="btn btn-info btn-lg" data-toggle="modal" data-target="#rksDesc"><i class="ft ft-file-plus"></i> Description</a>
  							<?php } ?>
              </table>
            </div>
          </div>
