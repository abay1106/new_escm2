<div class="wrapper wrapper-content animated fadeInRight">
  <div class="row">
    <div class="col-lg-12">
      ...
      include 'daftar_pekerjaan/daftar_pekerjaan_verifikasi_doc_pq.php';
      include 'daftar_pekerjaan/daftar_pekerjaan_verifikasi.php';
      include 'daftar_pekerjaan/daftar_pekerjaan_persetujuan_survei.php';
      include 'daftar_pekerjaan/daftar_pekerjaan_hasil_survei.php';
