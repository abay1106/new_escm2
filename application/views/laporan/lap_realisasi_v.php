<div class="wrapper wrapper-content animated fadeInRight">
  <div class="row">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5>Rencana VS Realisasi Detail</h5>
          <div class="ibox-tools">
            <a class="collapse-link">
              <i class="fa fa-chevron-up"></i>
            </a>
...
$detail.on('column-switch.bs.table', function (e, field, checked) {
  ...
  $('#filterMetode').change(function(){
    ...
    $rekap.bootstrapTable('refresh', {
         url: "<?php echo site_url('Laporan/data_realisasi_rekap') ?>?metode=" +metode
      })
  ...
  $('.btnExport').click(function(){
    ...
    window.open(url+'/realisasi/'+method+'?search='+search+'&limit='+limit+'&offset='+offset+'&sortName='+sortName+'&sortOrder='+sortOrder+'&column='+column, '_blank');
