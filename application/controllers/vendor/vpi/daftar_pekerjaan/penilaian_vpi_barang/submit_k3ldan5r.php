<?php 
 ...
 $post= $this->input->post();
  ...
  $data['vvk_k3l_value'] = $post['nilai_akhir_k3l_inp'];
  $data['vvk_5r_value'] = $post['nilai_akhir_5r_inp'];
  ...
  if ($this->form_validation->run() == FALSE){
    ...
    $this->vpi('daftar_pekerjaan','penilaian_vpi',$data['vvh_id'],'barang','k3ldan5r');
