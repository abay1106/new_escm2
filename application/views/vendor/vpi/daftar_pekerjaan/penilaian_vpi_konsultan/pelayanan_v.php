...
<div class="row">
  <div class="col-lg-12">
    <div class="ibox float-e-margins">
      ...
      <div class="ibox-content">
      <div class="form-group">
        <?php $curval = isset($prev_data['vpp_note_attach']) ? $prev_data['vpp_note_attach'] : "";
              $data_url = isset($prev_data['vpp_note_attach']) ? site_url('log/download_attachment/vendor/').'/'.$prev_data['vpp_note_attach'] : "#"; 
         ?>
