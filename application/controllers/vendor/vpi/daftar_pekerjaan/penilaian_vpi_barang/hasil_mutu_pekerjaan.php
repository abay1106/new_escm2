<?php 
$view = 'vendor/vpi/daftar_pekerjaan/penilaian_vpi_barang/hasil_mutu_pekerjaan_v';
$vvh_id = $param3;
...
$pertanyaan = $this->Administration_m->getHasilMutuPekerjaan("",'barang')->result_array();
...
if (count($prev_data) > 0) {
	...
	if (!$exists) {
		...
		$this->db->order_by('ahm_seq', 'asc');
		$prev_pertanyaan = $this->Administration_m->getHasilMutuPekerjaan("",'barang')->result_array();
