  ...
  <div class="col-lg-12">
    <div class="ibox float-e-margins">
      <div class="ibox-title">
        <h5>ITEM Shipping Instruction</h5>
      ...
      <div class="ibox-content">
        ...
        <div class="form-group" style="display: none">
          ...
          <label class="col-sm-4 control-label">Nilai SI Setelah PPN &amp; PPH</label>
          <div class="col-sm-3">
        ...
        <input type="hidden" name="totalwo" id="totalwo" value="<?php echo $totalwo?>">
      </div>
    </div>
  </div>
</div>
