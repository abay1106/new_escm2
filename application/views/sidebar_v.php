...
<!-- <div class="app-sidebar menu-fixed" data-background-color="info" data-image="<?php echo base_url('assets') ?>/app-assets/img/sidebar-bg/07.jpg" data-scroll-to-active="true"> -->
