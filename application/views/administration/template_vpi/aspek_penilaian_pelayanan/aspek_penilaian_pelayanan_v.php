...
<script type="text/javascript">
  ...
  $(function () {
    ...
    $table.bootstrapTable({
      ...
      url: "<?php echo site_url('administration/template_vpi/aspek_penilaian_pelayanan/data_aspek_penilaian_pelayanan') ?>",
        ...
        editable: {
          ...
          validate: function(v) {
              if(!v){ return 'Required field!'}
                  ...
                  $.ajax({
                  url: "<?php echo site_url('administration/template_vpi/aspek_penilaian_pelayanan/update?key=urutan&data=') ?>"+v,
                  type:"get"
                });
...
<div class="modal fade" id="modal_add_pertanyaan" tabindex="-1" role="dialog" aria-labelledby="modal_add_pertanyaanLabel" aria-hidden="true">
  <div class="modal-dialog  modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo site_url('administration/template_vpi/aspek_penilaian_pelayanan/submit_add') ?>" id="app_form" >
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#app_form').submit(function(e) {
      ...
      $('#app_form').ajaxSubmit({
        url: '<?php echo site_url('administration/template_vpi/aspek_penilaian_pelayanan/submit_add') ?>', 
        type: 'post',
   ...
   $remove.click(function(e) {
      e.preventDefault(); // avoid to execute the actual submit of the form.
           $.ajax({
                 type: "POST",
                 url: "<?php echo site_url('administration/template_vpi/aspek_penilaian_pelayanan/nonaktif');?>",
                 success: function(data)
                 {
      ...
      e.preventDefault(); // avoid to execute the actual submit of the form.
           $.ajax({
                 type: "POST",
                 url: "<?php echo site_url('administration/template_vpi/aspek_penilaian_pelayanan/aktifkan');?>",
                 success: function(data)
                 {
                     alert(data); // show response from the php script.
                     $table.bootstrapTable('refresh');
