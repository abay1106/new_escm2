<?php if ($permintaan['ptm_type_of_plan'] == "rkp") { ?>
      ...
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
             <select class="form-control select" required name="mppp_inp" disabled>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
             <select class="form-control select" required name="mdiv_inp" id="mdiv_inp" disabled>
               <option value=""><?php echo lang('choose') ?></option>
  ...
  <script type="text/javascript">
    ...
    var lokasi = [];
    <?php foreach($mdiv as $key => $val){ ?>
      lokasi.push({lbl:"<?php echo $val['pos_code'] ?>",region_name:"<?php echo $val['region_name'] ?>"});
    <?php } ?>
