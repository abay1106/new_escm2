<div class="row">
  <div class="col-lg-12">
         ...
         <table class="table table-bordered" id="item_table">
          ...
          <tbody>
            ...
            foreach ($item as $key => $value) {
              $qty = (isset($item_si[$value['contract_item_id']])) ? $item_wo[$value['contract_item_id']] : 0;
              ?>

              <tr>
              <td><input type="checkbox" <?php echo (isset($item_si[$value['contract_item_id']])) ? "checked" : "" ?> class="item_wo" name="item[<?php echo $value['contract_item_id'] ?>]" value="1"></td>
   ...
   <div class="form-group">
    ...
    <label class="col-sm-4 control-label">Nilai SI</label>
    <div class="col-sm-3">
