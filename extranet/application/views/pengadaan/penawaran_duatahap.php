			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					<form role="form" id="header" method="POST" action="<?php echo site_url('pengadaan/submit_duatahap') ?>" class="form-horizontal">	
						...
						<div class="form-group"><label class="col-sm-3 control-label"><?php echo $this->lang->line('Nomor Penawaran'); ?> *</label>
						...
						<div class="form-group"><label class="col-sm-3 control-label"><?php echo $this->lang->line('Nilai Bidbond'); ?></label>
						...
						<div class="form-group"><label class="col-sm-3 control-label"><?php echo $this->lang->line('Lampiran Bidbond'); ?> <small>(Max 2MB)</small></label>
						...
						<div class="form-group"><label class="col-sm-3 control-label"><?php echo $this->lang->line('Kandungan Lokal'); ?></label>
						...
						<div class="form-group"><label class="col-sm-3 control-label"><?php echo $this->lang->line('Jangka Waktu Pelaksanaan'); ?> *</label>
						...
						<div class="form-group" id="selesai"><label class="col-sm-3 control-label"><?php echo $this->lang->line('Berlaku Hingga'); ?> *</label>
						...
						<div class="form-group"><label class="col-sm-3 control-label"><?php echo $this->lang->line('Lampiran Penawaran'); ?> * <small>(Max 10MB)</small></label>
						...
						<div class="form-group"><label class="col-sm-3 control-label"><?php echo $this->lang->line('Catatan'); ?></label>
						...
						<div class="form-group"><label class="col-sm-3 control-label"><?php echo $this->lang->line('Mata Uang'); ?></label>
