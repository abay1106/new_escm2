    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5>Aspek Penilaian Pelayanan</h5>
...
<script type="text/javascript">
  ...
  function operateFormatter(value, row, index) {
     var addlink = "<?php echo site_url('vendor/vpi/aspek_penilaian_pelayanan/add') ?>";
     var lihatlink = "<?php echo site_url('vendor/vpi/aspek_penilaian_pelayanan/detail') ?>";
    return [
