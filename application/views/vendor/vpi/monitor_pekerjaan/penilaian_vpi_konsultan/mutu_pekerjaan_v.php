<div class="wrapper wrapper-content animated fadeInRight">
  <form method="post" id="form_aspek_penilaian_mutu" action="<?php echo site_url($controller_name."/vpi/daftar_pekerjaan/penilaian_vpi/".$vvh_id."/konsultan/submit_mutu_pekerjaan");?>" class="form-horizontal">
      ...
      <div class="col-lg-12">
        <div class="ibox float-e-margins">
          ...
          foreach ($pertanyaan as $key => $value){ 
            ...
            ?> 
            <tr>
              <td><input disabled type="radio" name="select_category" required class="radio_btn form-check-input select_category_<?php echo $no-1 ?>" data-no="<?php echo $no-1 ?>" <?php echo $selected ?>></td>
              <td><?php echo $no ?></td>
              <td>
              ...
              <td><input type="hidden" <?php echo $disabled ?> required class="form-control money answer_inp answer_inp_<?php echo $no-1 ?>" name="answer_inp" value="<?php echo $curval ?>">
              <?php echo $curval ?></td>
            </tr>
...
<div class="row">
  <div class="col-lg-12">
    <div class="ibox float-e-margins">
      ...
      <?php $curval = !empty($prev_data['vpm_attach']) ? $prev_data['vpm_attach'] : 'no file';
...
<script type="text/javascript"> 
  $(document).ready(function() {
    ...
    <?php if(!isset($pertanyaan)){ ?>
      alert('Pertanyaan Hasil Mutu Pekerjaan Untuk Penyedia Konsultan Belum dibuat');
    <?php } ?>
