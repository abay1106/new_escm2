    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5>Aspek Penilaian Ketepatan Progress</h5>
...
<script type="text/javascript">
  ...
  function operateFormatter(value, row, index) {
     var addlink = "<?php echo site_url('vendor/vpi/aspek_penilaian_ketepatan_progress/add') ?>";
     var lihatlink = "<?php echo site_url('vendor/vpi/aspek_penilaian_ketepatan_progress/detail') ?>";
    return [
