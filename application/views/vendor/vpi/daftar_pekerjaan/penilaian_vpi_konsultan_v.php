...
<div class="row">
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5>Penilaian Penyedia Konsultan</h5>
          <div class="ibox-tools">
            <a class="collapse-link">
              <i class="fa fa-chevron-up"></i>
            </a>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td id="score_mutu_pekerjaan">
                ...
                <?php $score_mutu_pekerjaan =  isset($nilai_mutu) ? replace_comma($nilai_mutu) * replace_comma($data_bobot['bobot_mutu_pekerjaan']) : "";
            ...
            <tr>
              ...
              <td id="nilai_hasil_mutu_personal">
                <?php $score_mutu_personal = isset($nilai_mutu) ? replace_comma($nilai_mutu) * replace_comma($data_bobot['bobot_mutu_personal']) : ""; 
            ...
            <tr>
              ...
              <td id="score_pelayanan">
                <?php $score_pelayanan = isset($nilai_pelayanan) ? replace_comma($nilai_pelayanan) * replace_comma($data_bobot['bobot_pelayanan']) : "";
