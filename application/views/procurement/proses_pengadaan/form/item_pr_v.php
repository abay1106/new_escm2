  ...
  <div class="col-lg-12">
    <div class="ibox float-e-margins">
      <div class="ibox-title">
        <h5>ITEM PERENCANAAN NON MATERIAL STRATEGIS</h5>
          ...
          <div class="col-sm-6">
            <div class="input-group">
              <span class="input-group-btn">
                   <button type="button" data-id="kode_item" data-url="<?php echo site_url(COMMODITY_KATALOG_BARANG_PATH.'/picker') ?>" class="btn btn-primary picker barang_btn not_integrated">Pilih Barang</button> 
                   <button type="button" data-id="kode_item" data-url="<?php echo site_url(COMMODITY_KATALOG_JASA_PATH.'/picker') ?>" class="btn btn-primary picker jasa_btn not_integrated">Pilih Jasa</button>
                  <button type="button" data-id="kode_item" id="item_int_btn" data-url="<?php echo site_url('procurement/get_picker_sumberdaya') ?>" class="btn btn-primary picker sumberdaya_btn integrated">Pilih sumberdaya</button>
              
                <!-- <button type="button" data-id="kode_item" data-url="<?php //echo site_url(COMMODITY_KATALOG_BARANG_PATH.'_sumberdaya/picker') ?>" class="btn btn-primary picker barang_btn">Pilih Barang</button> 
               <button type="button" data-id="kode_item" data-url="<?php //echo site_url(COMMODITY_KATALOG_JASA_PATH.'_sumberdaya/picker') ?>" class="btn btn-primary picker jasa_btn">Pilih Jasa</button> -->
             </span>
...
<div class="form-group">
  ...
  <div class="col-sm-3">
    ...
    <input type="hidden" name="sisa_pagu_awal_inp" id="sisa_pagu_awal_inp" value="<?php echo $permintaan['pr_sisa_anggaran'] ?>">
  </div>
</div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $(document.body).on("change","#kode_item",function(){
      ...
      var id = $(this).val();
      //var url = "<?php //echo site_url('Commodity/data_mat_catalog_smbd') ?>";
       var url = "<?php echo site_url('Commodity/data_mat_catalog') ?>";

      if(tipe == "JASA"){
        //var url = "<?php //echo site_url('Commodity/data_kat_jasa_smbd') ?>";
      ...
      $('.int_item').css('display','none');
        ...
        $.ajax({
          ...
          $('.int_item').css('display','');
            ...
            $('#max_volume').html("<span id='max'><i>batas max "+parseFloat(mydata.ppv_remain).toLocaleString(undefined, {minimumFractionDigits: 2,maximumFractionDigits: 8})+" "+mydata.unit+"</i></span>");
            $("#jumlah_item_inp").val(1);
