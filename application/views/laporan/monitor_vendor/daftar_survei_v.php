         ...
         <div class="ibox float-e-margins">
            ...
            <div class="ibox-content" style="">
               <div class="form-group">
                  <div class="row">
                     <label class="col-sm-2 control-label">Tanggal Verifikasi</label>
                     <div class="col-sm-4">
               ...
               <div class="form-group">
                  <div class="row">
                     ...
                     <div class="col-sm-4">
                        <div class="input-group">
                           <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                           <input type="text" name="tgl_mulai_s_inp" class="form-control tgl_mulai_s_inp date">
                        </div>
                     </div>
                     <div class="col-sm-4 date">
                        <div class="input-group">
                           <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                           <input type="text" name="tgl_akhir_s_inp" class="form-control tgl_akhir_s_inp date">
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="ibox-content">
               ...
               <div class="row">
                  <div class="col-md-12">
                     ...
                     <a href="<?php site_url();?>index.php/laporan/laporan_pdf_survei_vend" type="button"
                     ...
                     <a href="<?php site_url();?>index.php/laporan/laporan_excel_vendor_survei" type="button"
...
$(function() {
   ...
   $daftar_seluruh_vendor.bootstrapTable({
      ...
      url: "<?php echo site_url('Laporan/data_survei_vendor') ?>",
...
$('.tgl_mulai_s_inp').on('dp.change', function(e) {
   var mulai = $(this).val();
   var url = "<?php echo site_url('laporan/set_session/tgl_awal_s') ?>";
   $.ajax({
      url: url + "/" + mulai,
      success: function(data) {
         $("#daftar_seluruh_vendor").bootstrapTable('refresh');
...
$('.tgl_akhir_s_inp').on('dp.change', function(e) {
   var akhir = $(this).val();
   var url = "<?php echo site_url('laporan/set_session/tgl_akhir_s') ?>";
   $.ajax({
      url: url + "/" + akhir,
      success: function(data) {
         $("#daftar_seluruh_vendor").bootstrapTable('refresh');
...
$("input[name=jenis_status]").on('click', function(e) {
   if ($(this).prop("checked")) {
      ...
      $('#daftar_seluruh_vendor').bootstrapTable('refresh', {
         url: "<?php echo site_url('Laporan/data_survei_vendor') ?>?Active=" + Active +
            "&Inactive=" + Inactive +
            "&Suspended=" + Suspended +
            "&Blacklist=" + Blacklist +
            "&Suplier=" + Suplier +
