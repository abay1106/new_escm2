    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-header border-bottom pb-2">
          ...
          <a class="btn btn-info float-right" href="<?php echo site_url('administration/master_data/delivery_point/add_delivery_point') ?>" role="button">Tambah</a>
        </div>
...
<script type="text/javascript">
  ...
  function operateFormatter(value, row, index) {
    ...
    return [
      ...
      'Ubah',
      '</a>  ',
      '<a class="btn btn-sm btn-danger ft ft-danger btn-xs action" onclick="return confirm(\'Anda yakin ingin menonaktifkan departemen?\')" href="' + link + '/nonaktif/' + value + '">',
      'Nonaktif',
      '</a> </div>',
    ].join('');
  }
