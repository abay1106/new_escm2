...
<form method="post" action="<?php echo site_url($controller_name."/vpi/daftar_pekerjaan/penilaian_vpi/".$vvh_id."/jasa/submit_kompilasi");?>"  class="form-horizontal">
      ...
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          ...
          <tbody>
            <tr>
              <td>
                <a class="btn btn-xs btn-primary" href="<?php echo current_url().'/'.'jasa/ketepatan_progress' ?>">
                Nilai
              </a></td>
              ...
              <td id="score_ketepatan_progress">
                    <?php $score_ketepatan_progress =  isset($nilai_ketepatan_progress) ? replace_comma($nilai_ketepatan_progress) * replace_comma($data_bobot['bobot_ketepatan_progress']) : "";
            ...
            <tr>
              <td>
                <a class="btn btn-xs btn-primary" href="<?php echo current_url().'/'.'jasa/mutu_pekerjaan' ?>">
                  Nilai
                </a>
              </td>
              <td>
              ...
              <td id="score_hasil_mutu_pekerjaan">
                ...
                <?php $score_hasil_mutu_pekerjaan =  isset($nilai_mutu_pekerjaan) ? replace_comma($nilai_mutu_pekerjaan) * replace_comma($data_bobot['bobot_hasil_mutu_pekerjaan']) : "";
            ...
            <tr>
              <td rowspan="2" style="vertical-align: middle;">
                <a class="btn btn-xs btn-primary" href="<?php echo current_url().'/'.'jasa/k3ldan5r' ?>">
                  Nilai
                </a>
              </td>
              ...
              <td id="score_k3l">
                <?php $score_k3l = isset($nilai_k3l) ? replace_comma($nilai_k3l) * replace_comma($data_bobot['bobot_k3l']) : ""; 
            ...
            <tr>
              ...
              <td id="score_5r">
                <?php $score_5r = isset($nilai_5r) ? replace_comma($nilai_5r) * replace_comma($data_bobot['bobot_5r']) : "";
            ...
            <tr>
              <td>
                <a class="btn btn-xs btn-primary" href="<?php echo current_url().'/'.'jasa/pengamanan' ?>">
                  Nilai
                </a>
              </td>
              <td>Pengamanan</td>
              ...
              <td id="score_pengamanan">
                <?php $score_pengamanan =  isset($nilai_pengamanan) ? replace_comma($nilai_pengamanan) * replace_comma($data_bobot['bobot_pengamanan']) : "";
...
<?php echo buttonsubmit('vendor/vpi/monitor_pekerjaan/'.$vvh_data['contract_id'],lang('back'),lang('save')) ?>
