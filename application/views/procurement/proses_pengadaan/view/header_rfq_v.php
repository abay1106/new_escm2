          ...
          <div class="row">
              <div class="col-md">
                  <div class="card-content">
                    ...
                    <div class="row form-group">
                      <label class="col-sm-4 control-label text-right">Nomor Tender</label>
                      <div class="col-sm-8">
                    ...
                    <div class="row form-group">
                      <label class="col-sm-4 control-label text-right">Divisi/Departemen</label>
                      <div class="col-sm-8">
                        <p class="form-control-static"><?= $curval ?></p>
                      </div>
                    </div>
                    ...
                    <div class="row form-group">
                      <label class="col-sm-4 control-label text-right">Tanggal Pembuatan</label>
                      <div class="col-sm-8">
                        <p class="form-control-static"><?= $curval ?></p>
                      </div>
                    </div>
                    ...
                    <div class="row form-group">
                      <label class="col-sm-4 control-label text-right">Nama Pekerjaan</label>
                      <div class="col-sm-8">
              ...
              <div class="col-md">
                  ...
                  if (isset($permintaan['ptm_project_name'])) { ?>
                    <div class="row form-group">
                      <label class="col-sm-4 control-label text-right">Nama Proyek</label>
                      <div class="col-sm-8">
                  ...
                  <div class="row form-group">
                    <label class="col-sm-4 control-label text-right" style="line-height: 20px;">Download Berita Acara Aanwijzing</label>
                    <div class="col-sm-8">
                  ...
                  <?php if ($permintaan['isjoin'] != 1) { ?>
                    ...
                    <div class="row form-group">
                      <label class="col-sm-4 control-label text-right">Mata Anggaran</label>
                      <div class="col-sm-8">
                ...
                if(!empty($curval)){ ?>
                  ...
                  <div class="row form-group">
                    <label class="col-sm-4 control-label text-right">Sub Mata Anggaran</label>
                    <div class="col-sm-8">
                ...
                <div class="row form-group">
                  <label class="col-sm-4 control-label text-right">Mata Uang</label>
                  <div class="col-sm-8">
                ...
                <div class="row form-group">
                  <label class="col-sm-4 control-label text-right">Sisa Anggaran</label>
                  <div class="col-sm-8">
                ...
                <?php } ?>
                    ...
                    <?php if ($activity_id >= 1141) { ?>
                      <div class="row form-group">
                        <label class="col-sm-4 control-label text-right">Tipe Pemenang</label>
                        <div class="col-sm-8">
                          <div class="checkbox">
                            <?php
