...
<!--          <div class="col-sm-6">
        ...
        <div class="col-sm-6">
            <div class="input-group">
              <span class="input-group-btn">
                <button type="button" data-id="attachment_inp_sanggahan" data-folder="procurement/sanggahan" data-preview="preview_file_sanggahan" class="btn btn-primary upload">
                  <i class="fa fa-cloud-upload"></i> Upload
                </button> 
                 <button type="button" data-url="" class="btn btn-primary preview_upload" id="preview_file_sanggahan">
