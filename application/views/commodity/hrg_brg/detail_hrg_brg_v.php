  ...
  <div class="row">
    ...
    <?php $curval = (isset($mat_price['mat_catalog_code'])) ? $mat_price['mat_catalog_code'] : set_value("catalog_inp") ?>
      ...
      <?php $curval = (isset($mat_price['short_description'])) ? $mat_price['short_description'] : set_value("short_description") ?>
        ...
        <?php $curval = (isset($mat_price['unit_price'])) ? $mat_price['unit_price'] : set_value("unit_price_inp") ?>
        ...
        <?php $curval = (isset($mat_price['handling_cost'])) ? $mat_price['handling_cost'] : set_value("handling_cost_inp") ?>
        <?php $curval = inttomoney($curval) ?>
        <div class="form-group">
        ...
        <?php $curval = (isset($mat_price['insurance_cost'])) ? $mat_price['insurance_cost'] : set_value("insurance_cost_inp") ?>
        <?php $curval = inttomoney($curval) ?>
        <div class="form-group">
        ...
        <?php $curval = (isset($mat_price['freight_cost'])) ? $mat_price['freight_cost'] : set_value("freight_cost_inp") ?>
        <?php $curval = inttomoney($curval) ?>
        <div class="form-group">
        ...
        <?php $curval = (isset($mat_price['tax_duty'])) ? $mat_price['tax_duty'] : set_value("tax_duty_inp") ?>
        <?php $curval = inttomoney($curval) ?>
        <div class="form-group">
        ...
        <?php $curval = (isset($mat_price['total_cost'])) ? $mat_price['total_cost'] : set_value("total_cost_inp") ?>
        <?php $curval = inttomoney($curval) ?>
        <div class="form-group">
        ...
        <?php $curval = (isset($mat_price['discount'])) ? $mat_price['discount'] : set_value("discount_inp") ?>
        <?php $curval = inttomoney($curval) ?>
        <div class="form-group">
    ...
    //include(VIEWPATH."/catalog_comment_v.php"); 
    ?>
    </div>
  </div>
  </form>
