<?php if($permintaan['pr_type'] != "MATERIAL STRATEGIS"){ 
  include(VIEWPATH."procurement/proses_pengadaan/view/header_pr_v.php"); 
} else { ?>
  <div class="row">
    <div class="col-lg-12">
       ...
       <div class="form-group">
        ...
        <div class="col-sm-4">
          <div class="checkbox">
            ...
            <input type="checkbox" readonly onclick="swakelola_confirm()" class="" name="swakelola_inp" id="swakelola_inp" value="1">
          </div>
        </div>
      </div>
