...
<div class="row">
  <div class="col-lg-12">
    <div class="ibox float-e-margins">
      ...
      <div class="ibox-content">
      <div class="form-group">
        <?php $curval = !empty($prev_data['vvk_note_attach']) ? $prev_data['vvk_note_attach'] : "no file";
              $data_url = !empty($prev_data['vvk_note_attach']) ? site_url('log/download_attachment/vendor/').'/'.$prev_data['vvk_note_attach'] : "#"; 
         ?>
