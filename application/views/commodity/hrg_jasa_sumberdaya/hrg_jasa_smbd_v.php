    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <div class="row">
              <div class="col-sm-3">
              <form class="form-horizontal" method="post" action="<?php echo site_url('commodity/daftar_harga/daftar_harga_jasa_sumberdaya/add');?>">
              ...
              <div class="col-sm-9">
                <div class="btn-group pull-right">
                  ...
                  <a href="<?php echo site_url('commodity/daftar_harga/daftar_harga_jasa_sumberdaya/edit');?>" class="btn btn-info btn-flat">Ubah</a>
...
$table.bootstrapTable({
  url: "<?php echo site_url('Commodity/data_hrg_jasa_smbd') ?>",
