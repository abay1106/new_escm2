<div class="wrapper wrapper-content animated fadeInRight">
  <form method="post" id="form_aspek_penilaian_pelayanan" action="<?php echo site_url($controller_name."/vpi/daftar_pekerjaan/penilaian_vpi/".$vvh_id."/konsultan/submit_pelayanan");?>"  class="form-horizontal">
      ...
      <div class="col-lg-12">
        <div class="ibox float-e-margins">
          ...
          foreach ($pertanyaan as $key => $value){ 
            $curval = isset($value['vppa_value']) ? $value['vppa_value'] : "";
            $id = isset($value['vppa_id']) ? $value['vppa_id'] : ""; 
            ?> 
            <tr>
              <td><?php echo $no ?></td>
              <td>
...
<div class="col-lg-12">
  <div class="ibox float-e-margins">
    ...
    <div class="ibox-content">
    <?php $curval = isset($prev_data['vpp_value']) ? $prev_data['vpp_value']  : ""?>
    <div class="form-group" style="text-align: center;">
        <label><h3>Skor Penyedia Konsultan </h3></label><br>
...
<div class="row">
  <div class="col-lg-12">
    <div class="ibox float-e-margins">
      ...
      <div class="ibox-content">
      <div class="form-group">
        <?php $curval = !empty($prev_data['vpp_note_attach']) ? $prev_data['vpp_note_attach'] : "no file";
              $data_url = !empty($prev_data['vpp_note_attach']) ? site_url('log/download_attachment/vendor/').'/'.$prev_data['vpp_note_attach'] : "#"; 
         ?>
      ...
      <?php $curval = isset($prev_data['vpp_note']) ? $prev_data['vpp_note'] : ""  ?>
      <div class="form-group">
