...
<table style="width: 100%;" id="table-content" class="is-content">
		...
		<tr>
			...
			<th style="border-right: 0px;" ><img width="50"   src="./assets/img/favicon.png"></th>
		...
		<tr>
			...
			<?php
				$index = 0;
				foreach ($vendor as $value) {
					echo "<td colspan='2'>".$cara_pembayaran[$index]."</td>";
					$index += 1;
				}
			?>
		...
		<tr>
			...
			<?php
				$index = 0;
				foreach ($vendor as $value) {
					echo "<td colspan='2'>".$taxs[$index]."</td>";
					$index += 1;
				}
			?>
		...
		<tr>
			...
			<?php
				$index = 0;
				foreach ($vendor as $value) {
					echo "<td colspan='2'>".$lain[$index]."</td>";
					$index += 1;
				}
			?>
