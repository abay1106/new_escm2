...
<script type="text/javascript">
  ...
  function wo_act(value, row, index) {
    ...
    return [
    '<a class="btn btn-primary btn-xs action" href="'+link+'/proses_sppm_matgis/'+value+'">',
    'Proses',
    '</a>  ',
    ].join('');
  }
  ...
  $(function () {
    ...
    $table_pekerjaan_wo.bootstrapTable({
      ...
      url: "<?php echo site_url('contract/data_wo_matgis_aktif') ?>",
