<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <div class="row">
              <div class="col-sm-3">
              <form class="form-horizontal" method="post" action="<?php echo site_url('commodity/katalog/grup_barang_sumberdaya/add');?>">
                <div class="input-group margin pull-left">
                  ...
                  <a href="<?php echo site_url('commodity/katalog/grup_barang_sumberdaya/edit');?>" class="btn btn-info btn-flat">Ubah</a>
                </div>
                </form>
              </div>
              <!-- <div class="col-sm-9">
  ...
  //console.log(name, args);
	...
	function refreshDatatable(){
		...
		$table.bootstrapTable('refresh', {url: "<?php echo site_url('Commodity/data_grup_brg_smbd?parent=') ?>"+lvl});
	}
