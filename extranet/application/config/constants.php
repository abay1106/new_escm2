...
define("EXTRANET_URL", "https://escm.wika.co.id");
...
define("INTRANET_UPLOAD_FOLDER", "https://scm.wika.co.id/uploads");
...
define("COMPANY_WEBSITE","https://scm.wika.co.id/");
define("SESSION_PREFIX","wika_int");
define("WEBSOCKET_URL","ws://192.168.2.206:8899/");
define("HEADQUATERS_CODE", "110");

define("INTRANET_DOWNLOAD_URL", "https://scm.wika.co.id/log/download_attachment/");
define("INTRANET_PATH", "https://scm.wika.co.id/");
define("ALLOWED_EXT_FILES", ".doc, .docx, .xls, .xlsx, .ppt, .pptx, .pdf, image/jpg, image/jpeg, image/png, .Zip, .rar, .tgz, .7zip, .tar");
define('SIMPABEAN_URL', 'https://wika-api.rofasys.id/pabean');
