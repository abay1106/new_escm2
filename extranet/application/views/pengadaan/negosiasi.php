<div class="row">
	<div class="col-7">
		<div class="content-header"><strong><?php echo $this->lang->line('Informasi Negosiasi'); ?></strong></div>			
	</div>
	<div class="col-5">
			...
			<div class="ibox float-e-margins">
				...
				<div class="ibox-content">
					...
					<form id="komentar" method="POST" action="<?php echo site_url('pengadaan/submit_nego') ?>" class="form-horizontal">	
						...
						<textarea required class="form-control" rows="5" id="comment" name="comment" placeholder="required"></textarea>
					</form>
				</div>
