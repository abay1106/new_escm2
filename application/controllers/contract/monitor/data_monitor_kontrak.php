...
if(!empty($search)){
  ...
  $this->db->or_like("LOWER(vw_ctr_monitor.ptm_number)",$search);
  $this->db->or_like("LOWER(vw_ctr_monitor.contract_number)",$search);
...
foreach ($rows as $key => $value) {
  $rows[$key]['vw_ctr_monitor.ptm_number'] = $rows[$key]['ptm_number'];
}
