              ...
              <div class="col-sm-6">
                <div class="input-group">
                  <span class="input-group-btn">
                      <button type="button" data-id="kode_item" data-url="<?php echo site_url(COMMODITY_KATALOG_BARANG_PATH.'/picker') ?>" class="btn btn-info picker barang_btn not_integrated">Pilih Barang</button> 
                      <button type="button" data-id="kode_item" data-url="<?php echo site_url(COMMODITY_KATALOG_JASA_PATH.'/picker') ?>" class="btn btn-info picker jasa_btn not_integrated">Pilih Jasa</button>
                      <button type="button" data-id="kode_item" id="item_int_btn" data-url="<?php echo site_url('procurement/get_picker_sumberdaya') ?>" class="btn btn-info picker sumberdaya_btn integrated">Pilih sumberdaya</button>                
                </span>
    ...
    <table class="table table-bordered" id="item_table">
      ...
      <tbody>
        ...
        if(isset($item) && !empty($item)){
          ...
          <tr>
            <td>
              <button data-no="<?php echo $idnya ?>" class="btn btn-info btn-xs edit_item" type="button">
  ...
  $(document).ready(function(){
    ...
    $(".action_item").click(function(){ 
      ...
      if(harga_satuan_int < 1){
        ...
        var html = "<tr><td><button type='button' class='btn btn-info btn-xs edit_item' data-no='"+no+"'><i class='fa fa-edit'></i></button></td>";
