...
<br>
<form method="POST" target="_blank" action="<?php echo base_url(); ?>index.php/procurement/pdf_bakp_print" style="margin-top: -55px;">
...
<div class="shadow p-3 mb-3 bg-white rounded">
	<center><b><p style="font-weight:bold;">Komisi  Pengadaan Divisi</p></b></center>
...
<button type="submit" id="submit" class="btn btn-info btn-lg" style="margin: 5px;cursor: pointer;"><i class="fa fa-file-pdf-o"></i> BAKP PRINT PDF</button>

</form>


	<div id="form_other" style="display:<?php echo ($data_uskep) ? '' : 'none'; ?>;" >
		<a  href="<?php echo base_url()."index.php/Privy/upload_doc/".$ptm_id; ?>" class="btn btn-info btn-lg" style="margin: 5px;"><i class="ft ft-upload"></i> Upload & Share E-Sign</a>
		<a  href="<?php echo base_url()."index.php/procurement/pdf_penawaran_harga/".$ptm_id; ?>" class="btn btn-info btn-lg" style="margin: 5px;"><i class="ft ft-file-text"></i> DEPKN FORM</a>
		<a  href="<?php echo base_url()."index.php/procurement/pdf_penilaian/".$ptm_id; ?>" class="btn btn-info btn-lg" style="margin: 5px;"><i class="ft ft-edit"></i> PENILAIAN FORM</a>
	</div>
