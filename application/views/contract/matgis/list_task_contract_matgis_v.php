    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5>Daftar Pekerjaan Kontrak Matgis</h5>
        ...
        <div class="ibox-content">
          <div class="table-responsive">
            <!-- <a class="btn btn-primary" href="<?php //echo site_url().'/contract/push_w_matgis' ?>">Push PO/Work Order Matgis</a> -->
...
function operateFormatter(value, row, index) {
  ...
  return [
    '<a class="btn btn-primary btn-xs action" href="'+link+'/process_matgis/wo/'+value+'/1">',
    'Proses',
    '</a>  ',
  ].join('');
}
...
$(function () {
  ...
  $table_work_order.bootstrapTable({
    ...
    url: "<?php echo site_url('data_matgis/data_create_matgis/'.$mod)?>",
