<div class="wrapper wrapper-content animated fadeInRight">
  <form method="post" action="<?php echo site_url($controller_name."/submit_edit_rks");?>"  class="form-horizontal">
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <?php
              $header_main = $data["header_main"];
              $header_sub = $data["header_sub"];
              $description = $data["description"];
            ?>
            <div class="form-group">
              <label for="exampleInputEmail1">RKS Header</label>
              <input type="text" class="form-control" id="header_main" name="header_main" placeholder="Enter Header Main" value="<?= $header_main ?>">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">RKS Header Sub</label>
              <input type="text" class="form-control" id="header_sub" placeholder="Enter Header Sub" name="header_sub" value="<?= $header_sub ?>">
            </div>
            <div class="form-group">
