<?php  if( !empty($prep['adm_bid_committee'])){ ?>
      ...
      <div class="card">
        ...
        <div class="card-content">
          <div class="card-body">
              ...
              <div class="row form-group" id="panitia_pengadaan_cont">
                <label class="col-sm-2 control-label text-right">Tim Panitia</label>
                <div class="col-sm-6">
                    <input type="hidden" class="form-control text-right" id="panitia_pengadaan_inp" name="panitia_pengadaan_inp" value="<?php echo $curval ?>">
              ...
              <div class="row form-group" id="panitia_pengadaan_doc">
                <label class="col-sm-2 control-label text-right">Dokumen Panitia</label>
                <div class="col-sm-6">
