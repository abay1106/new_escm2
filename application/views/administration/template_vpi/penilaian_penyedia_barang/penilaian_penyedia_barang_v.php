        ...
        <div class="ibox-content">
          ...
          <tbody>
            ...
            <tr>
              <td>2</td>
              <td>
                <a href="<?php echo site_url('administration/template_vpi/penilaian_penyedia_barang/hasil_mutu_pekerjaan') ?>">Hasil Mutu Pekerjaan</a>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <a href="<?php echo site_url('administration/template_vpi/penilaian_penyedia_barang/k3l') ?>">
                  K3L
                </a>
              </td>
              <td>
            ...
            <tr>
              <td>4</td>
              <td>
                <a href="<?php echo site_url('administration/template_vpi/penilaian_penyedia_barang/5r') ?>">
                  5R
                </a>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>Pengamanan</td>
              <td>
                <a href="<?php echo site_url('administration/template_vpi/penilaian_penyedia_barang/pengamanan') ?>">
                  Pengamanan
                </a>
              </td>
              <td>
...
$(document).ready(function() {
  ...
  var url= "<?php echo site_url('administration/template_vpi/penilaian_penyedia_barang/bobot_dan_target/submit?') ?>";
  ...
  $target_ketepatan_progress.editable({
          ...
          success: function(response, newValue) {
                ...
                $.ajax({
                  url: url+"key=target_ketepatan_progress&data="+newValue+"&total="+total+"&type=barang",
                  type:"get"
                });
  ...
  $bobot_ketepatan_progress.editable({
          ...
          success: function(response, newValue) {
            if (check_total_bobot(current_bobot_ketepatan_progress,newValue) == "less than"){
                ...
                $.ajax({
                  url: url+"key=bobot_ketepatan_progress&data="+newValue+"&total="+total+"&type=barang",
                  type:"get"
                });
  ...
  $target_hasil_mutu_pekerjaan.editable({
          ...
          success: function(response, newValue) {
                ...
                $.ajax({
                  url: url+"key=target_hasil_mutu_pekerjaan&data="+newValue+"&total="+total+"&type=barang",
                  type:"get"
                });
  ...
  $bobot_hasil_mutu_pekerjaan.editable({
          ...
          success: function(response, newValue) {
                ...
                $.ajax({
                  url: url+"key=bobot_hasil_mutu_pekerjaan&data="+newValue+"&total="+total+"&type=barang",
                  type:"get"
                });
  ...
  $target_k3l.editable({
          ...
          success: function(response, newValue) {
                ...
                $.ajax({
                  url: url+"key=target_k3l&data="+newValue+"&total="+total+"&type=barang",
                  type:"get"
                });
  ...
  $bobot_k3l.editable({
          ...
          success: function(response, newValue) {
            if (check_total_bobot(current_bobot_k3l,newValue) == "less than"){
                ...
                $.ajax({
                  url: url+"key=bobot_k3l&data="+newValue+"&total="+total+"&type=barang",
                  type:"get"
                });
  ...
  $target_5r.editable({
          ...
          success: function(response, newValue) {
                ...
                $.ajax({
                  url: url+"key=target_5r&data="+newValue+"&total="+total+"&type=barang",
                  type:"get"
                });
  ...
  $bobot_5r.editable({
          ...
          success: function(response, newValue) {
                ...
                $.ajax({
                  url: url+"key=bobot_5r&data="+newValue+"&total="+total+"&type=barang",
                  type:"get"
                });
  ...
  $target_pengamanan.editable({
          ...
          success: function(response, newValue) {
                ...
                $.ajax({
                  url: url+"key=target_pengamanan&data="+newValue+"&total="+total+"&type=barang",
                  type:"get"
                });
  ...
  $bobot_pengamanan.editable({
          ...
          success: function(response, newValue) {
              if (check_total_bobot(current_bobot_pengamanan,newValue) == "less than"){
                ...
                $.ajax({
                  url: url+"key=bobot_pengamanan&data="+newValue+"&total="+total+"&type=barang",
                  type:"get"
                });
