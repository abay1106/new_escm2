			...
			<div class="tabs-container">
				...
				<div class="tabs-left">
					<ul class="nav nav-tabs">
						<li class="<?= $must_upload  ? "" : "active" ?>"><a data-toggle="tab" href="#tab-1"><?php echo $this->lang->line('Data Utama'); ?></a></li>
						...
						<li class=" <?= $must_upload  ? "active" : "" ?> "><a data-toggle="tab" href="#tab-12"><?php echo $this->lang->line('Upload Dokumen PQ'); ?></a></li>
					</ul>
								...
								<div class="col-lg-12 m-l-n">
									...
									<div class="row">	
										...
										<div class="col-lg-5" margin-bottom: 3%>
											<input name="file_<?=$key?>" 
											data-no="<?=$key?>" 
											style="margin-bottom: 1%" 
											type="file" class="file" 
											accept=".doc, .docx, .xls, .xlsx, .ppt, .pptx, .pdf, image/jpg, image/jpeg, image/png, .Zip, .rar, .tgz, .7zip, .tar"  <?= $value['doc_file'] ? "" : "required" ?> >
											...
											<?php if ($value['vdd_ref_document_pq']) {?>
													<a target="_blank" href="<?php echo site_url('welcome/download/vendor/'.$this->umum->forbidden($this->encryption->encrypt($value['vdd_ref_document_pq']), 'enkrip'))?>"
