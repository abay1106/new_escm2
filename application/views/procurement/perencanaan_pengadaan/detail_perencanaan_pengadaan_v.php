      ...
      <div class="ibox-content">
       ...
       <!-- <table class="table table-bordered default">
        ...
        <tbody>
         <?php 
         $no = 1;
         foreach ($volume_hist as $key => $value_vh) {?>
          <tr>
            <td><?php echo $no; ?></td>
            <td><?php echo date(DEFAULT_FORMAT_DATETIME,strtotime($value_vh['created_datetime'])) ?></td>
            <td><?php echo !empty($value_vh['ppv_main']) ? str_replace('.', ',', $value_vh['ppv_main'] ) : number_format(0,8,',','.')?></td>
            <td><?php echo !empty($value_vh['ppv_plus']) ? str_replace('.', ',', $value_vh['ppv_plus'] ) : number_format(0,8,',','.') ?></td>
            <td><?php echo !empty($value_vh['ppv_minus']) ? str_replace('.', ',', $value_vh['ppv_minus']) : number_format(0,8,',','.') ?></td>
            <td><?php echo !empty($value_vh['ppv_remain']) ? str_replace('.', ',', $value_vh['ppv_remain']) : number_format(0,8,',','.') ?></td>
            <td><?php echo $value_vh['ppv_smbd_code']; ?></td>
            <td><?php echo $value_vh['smbd_name']; ?></td>
            <td><?php echo $value_vh['ppv_unit']; ?></td>
            <td><?php echo $value_vh['ppv_prc'] == 'PR' ? 
            $value_vh['status']." <a href='".site_url('procurement/procurement_tools/monitor_pengadaan/lihat_permintaan/').$value_vh['ppv_no']."' target='_blank'>".$value_vh['ppv_no']."</a>" : ($value_vh['ppv_prc'] == 'RFQ' ? 
            $value_vh['status']." <a href='".site_url('procurement/procurement_tools/monitor_pengadaan/lihat/').$value_vh['ppv_no']."' target='_blank'>".$value_vh['ppv_no']."</a>" : ($value_vh['ppv_prc'] == 'CTR' ? 
            $value_vh['status']." <a href='".site_url('contract/monitor/monitor_kontrak/lihat/').$value_vh['ppv_no']."' target='_blank'>".$value_vh['ppv_no']."</a>"  : $value_vh['status'] ) ); ?></td>
          </tr>
        <?php
         $no++;
        }
