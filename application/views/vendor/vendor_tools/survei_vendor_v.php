         ...
         <div class="ibox float-e-margins">
            ...
            <div class="ibox-content" style="">
               <div class="form-group">
                ...
                <div class="form-group">
                  <div class="row">
                     <label class="col-sm-2 control-label">Tanggal Survei</label>
                     <div class="col-sm-4">
                        <div class="input-group">
                           <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                           <input type="text" name="tgl_mulai_survey_inp" class="form-control tgl_mulai_survey_inp date">
                        </div>
                     </div>
                     <div class="col-sm-4 date">
                        <div class="input-group">
                           <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                           <input type="text" name="tgl_akhir_survey_inp" class="form-control tgl_akhir_survey_inp date">
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="ibox-content">
               ...
               <div class="row">
                  <div class="col-md-12">
                     ...
                     <a href="<?php site_url();?>index.php/vendor/laporan_pdf_survei_vendor" type="button"
                     ...
                     <a href="<?php site_url();?>index.php/vendor/laporan_excel_survei_vendor" type="button"
...
$(function() {
   ...
   $daftar_seluruh_vendor.bootstrapTable({
      ...
      url: "<?php echo site_url('Vendor/data_survei_vendor') ?>",
...
$(".refresh").on("click", function() {
   var url = "<?php echo site_url('Vendor/clear_session_survei_vendor') ?>";
   $.ajax({
      url: url,
      success: function(data) {
...
$('.tgl_mulai_inp').on('dp.change', function(e) {
   var mulai = $(this).val();
   var url = "<?php echo site_url('Vendor/set_session/tgl_awal') ?>";
   $.ajax({
      url: url + "/" + mulai,
      success: function(data) {
         $("#daftar_seluruh_vendor").bootstrapTable('refresh');
...
$('.tgl_akhir_inp').on('dp.change', function(e) {
   var akhir = $(this).val();
   var url = "<?php echo site_url('Vendor/set_session/tgl_akhir') ?>";
   $.ajax({
      url: url + "/" + akhir,
      success: function(data) {
         $("#daftar_seluruh_vendor").bootstrapTable('refresh');
...
$('.tgl_mulai_survey_inp').on('dp.change', function(e) {
        // alert($(this).val());
   var mulai = $(this).val();
   var url = "<?php echo site_url('Vendor/set_session/tgl_survei_awal') ?>";
   $.ajax({
      url: url + "/" + mulai,
      success: function(data) {
         $("#daftar_seluruh_vendor").bootstrapTable('refresh');
...
$('.tgl_akhir_survey_inp').on('dp.change', function(e) {
   var akhir = $(this).val();
   var url = "<?php echo site_url('Vendor/set_session/tgl_survei_akhir') ?>";
   $.ajax({
      url: url + "/" + akhir,
      success: function(data) {
         $("#daftar_seluruh_vendor").bootstrapTable('refresh');
...
$('.vendor_name').on('keyup change', function(e) {
   ...
   var url = "<?php echo site_url('Vendor/set_session/vendor_name') ?>";
   $.ajax({
      url: url + "/" + vendor_name,
      success: function(data) {
         $("#daftar_seluruh_vendor").bootstrapTable('refresh');
...
$("input[name=jenis_status]").on('click', function(e) {
   if ($(this).prop("checked")) {
    ...
    //      Inactive = "3";
      ...
      $('#daftar_seluruh_vendor').bootstrapTable('refresh', {
         url: "<?php echo site_url('Vendor/data_survei_vendor') ?>?Active=" + Active +
            // "&Inactive=" + Inactive +
            "&Suspended=" + Suspended +
            "&Blacklist=" + Blacklist,
      });
