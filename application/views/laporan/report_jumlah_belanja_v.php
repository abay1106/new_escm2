  ...
  <div class="row">
   ...
   <div class="row">
    <div class="col-lg-12">
      ...
      <div class="ibox float-e-margins">
<!--         <div class="ibox-title">
          <h5><p id="tullisann" data-kosong="1">Rekap Jumlah Belanja</p></h5>
          <div class="ibox-tools">
            <a class="collapse-link">
              <i class="fa fa-chevron-up"></i>
            </a>
        ...
        <div class="ibox-content">
         ...
         <!--  <table class="table table-bordered table-striped">
          ...
          <table id="datatables-ss2" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th style="text-align:center;font-size: 1.2em;">No</th>
                <th style="text-align:center;font-size: 1.2em;">Nama Kelompok Sumberdaya</th>
                <th style="text-align:center;font-size: 1.2em;">Total Rfq</th>
                <th style="text-align:center;font-size: 1.2em;">Total Nilai Penawaran</th>
              </tr>
            </thead>
            <tbody>
...
<script>
  ...
  var   urlDb   = "<?php echo site_url('laporan/data_table_jumlah_belanja') ?>";
  var   totalClmn;
  var   table1;
